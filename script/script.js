...
nextBtnSl2.forEach(btn => {
    btn.addEventListener('click', () => { someSlider2.nextArrow() })
})

prevBtnSl2.forEach(btn => {
    btn.addEventListener('click', () => { someSlider2.prevArrow(); })
})
...
nextBtnSl4.forEach(btn => {
    btn.addEventListener('click', () => { someSlider4.nextArrow() })
})
prevBtnSl4.forEach(btn => {
    btn.addEventListener('click', () => { someSlider4.prevArrow() })
})
